...
# PRP System Setup Script
# Run this script to quickly set up the PRP system in a new project
...
# Create ai_docs README
cat > PRPs/ai_docs/README.md << 'EOF'
...
echo ""
echo "📝 Next steps:"
echo "  1. Run: python scripts/detect-tech-stack.py"
echo "  2. Create suggested ai_docs files"
echo "  3. Create your first PRP: cp PRPs/templates/prp_base.md PRPs/my-feature.md"
echo "  4. Edit the PRP and run: python PRPs/run_prp.py PRPs/my-feature.md"
echo ""
echo "📚 Documentation:"
echo "  - PRPs/README.md - Main PRP guide"
echo "  - PRPs/ai_docs/README.md - AI documentation guide"
echo "  - scripts/setup-guide.md - Detailed setup guide"